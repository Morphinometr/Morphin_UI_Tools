...
bl_info = {
    "name": "Pie_Snap",
    "description": "Snap Pie Menu (keymap: Ctrl+Shift+S)",
    "author": "Morphin",
    "blender": (2, 90, 0),
    "version": (0, 0, 1),
...
class PIE_MT_3DSnap(Menu):
    ...
    def draw(self, context):
        ...
        pie = layout.menu_pie()
        # 4 - LEFT
        pie.operator("snap3d.increment", text="Increment", icon='SNAP_INCREMENT')
        # 6 - RIGHT
        pie.operator("snap3d.vertex", text="Vertex", icon='SNAP_VERTEX')
        # 2 - BOTTOM
        pie.operator("snap3d.face", text="Face", icon='SNAP_FACE')
        # 8 - TOP
        pie.operator("snap3d.edge", text="Edge", icon='SNAP_EDGE')
        # 7 - TOP - LEFT
        pie.operator("snap3d.grid", text="Grid", icon='SNAP_GRID')
        # 9 - TOP - RIGHT
        pie.operator("snap3d.volume", text="Volume", icon='SNAP_VOLUME')
        # 1 - BOTTOM - LEFT
        pie.operator("snap3d.edge_center", text="Edge center", icon='SNAP_MIDPOINT')
        # 3 - BOTTOM - RIGHT
        pie.operator("snap3d.edge_perpendicular", text="Edge center", icon='SNAP_PERPENDICULAR')
